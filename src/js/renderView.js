...
import med_es_sorrowful_1 from './templates/meditations/med_es_sorrowful_1.html';
import med_es_sorrowful_2 from './templates/meditations/med_es_sorrowful_2.html';
import med_es_sorrowful_3 from './templates/meditations/med_es_sorrowful_3.html';
import med_es_sorrowful_4 from './templates/meditations/med_es_sorrowful_4.html';
import med_es_sorrowful_5 from './templates/meditations/med_es_sorrowful_5.html';
import med_es_luminous_1 from './templates/meditations/med_es_luminous_1.html';
import med_es_luminous_2 from './templates/meditations/med_es_luminous_2.html';
import med_es_luminous_3 from './templates/meditations/med_es_luminous_3.html';
import med_es_luminous_4 from './templates/meditations/med_es_luminous_4.html';
import med_es_luminous_5 from './templates/meditations/med_es_luminous_5.html';
...
export default function renderView(pathname, params) {
    ...
    switch (pathname) {
        ...
        case '/med_es_sorrowful_1':
            $('body').removeClass('fixed');
            $('div#app').append(med_es_sorrowful_1);
            break;

        case '/med_es_sorrowful_2':
            $('body').removeClass('fixed');
            $('div#app').append(med_es_sorrowful_2);
            break;

        case '/med_es_sorrowful_3':
            $('body').removeClass('fixed');
            $('div#app').append(med_es_sorrowful_3);
            break;

        case '/med_es_sorrowful_4':
            $('body').removeClass('fixed');
            $('div#app').append(med_es_sorrowful_4);
            break;

        case '/med_es_sorrowful_5':
            $('body').removeClass('fixed');
            $('div#app').append(med_es_sorrowful_5);
            break;

        case '/med_es_luminous_1':
            $('body').removeClass('fixed');
            $('div#app').append(med_es_luminous_1);
            break;

        case '/med_es_luminous_2':
            $('body').removeClass('fixed');
            $('div#app').append(med_es_luminous_2);
            break;

        case '/med_es_luminous_3':
            $('body').removeClass('fixed');
            $('div#app').append(med_es_luminous_3);
            break;

        case '/med_es_luminous_4':
            $('body').removeClass('fixed');
            $('div#app').append(med_es_luminous_4);
            break;

        case '/med_es_luminous_5':
            $('body').removeClass('fixed');
            $('div#app').append(med_es_luminous_5);
            break;
