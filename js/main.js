...
function HomeJS() {
  ...
  function updatePrayers(beadId) {
    ...
    if (beadId === 'crucifix') {
      if (_store__WEBPACK_IMPORTED_MODULE_0__["default"].settings.anotherDevotion === 'none') {
        prayers = [{
      ...
      if (_store__WEBPACK_IMPORTED_MODULE_0__["default"].settings.anotherDevotion === 'divine-mercy-chaplet') {
        prayers = [{
          title: _store__WEBPACK_IMPORTED_MODULE_0__["default"].prayers.signOfTheCross[language].title,
          text: _store__WEBPACK_IMPORTED_MODULE_0__["default"].prayers.signOfTheCross[language].text
        }];
...
function SettingsJS() {
    ...
    for (var i = 0; i < fields.length; i++) {
      ...
      if (field['name'] === 'another-devotion') {
        if (field['value'] === 'none' || field['value'] === 'divine-mercy-chaplet') {
          _store__WEBPACK_IMPORTED_MODULE_0__["default"].settings.anotherDevotion = field['value'];
  ...
  function updateAnotherDevotion() {
    $('#form-settings-another-devotion').find('option[value="' + _store__WEBPACK_IMPORTED_MODULE_0__["default"].settings.anotherDevotion + '"]').attr('selected', 'selected');
  }
}
;
