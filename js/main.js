  ...
  function updatePrayers(beadId, fromBeadId) {
    ...
    if (beadId === 'crucifix') {
      ...
      if (!_store__WEBPACK_IMPORTED_MODULE_0__.default.settings.divineMercy) {
        ...
        prayers = [{
          title: _store__WEBPACK_IMPORTED_MODULE_0__.default.prayers.divineMercy.optionalOpening[_store__WEBPACK_IMPORTED_MODULE_0__.default.settings.language].title,
          text: _store__WEBPACK_IMPORTED_MODULE_0__.default.prayers.divineMercy.optionalOpening[_store__WEBPACK_IMPORTED_MODULE_0__.default.settings.language].text
        }];
      }
      ...
      if (!_store__WEBPACK_IMPORTED_MODULE_0__.default.settings.divineMercy) {
        ...
        prayers = [{
          ...
          title: _store__WEBPACK_IMPORTED_MODULE_0__.default.prayers.divineMercy.optionalClosing[_store__WEBPACK_IMPORTED_MODULE_0__.default.settings.language].title,
          text: _store__WEBPACK_IMPORTED_MODULE_0__.default.prayers.divineMercy.optionalClosing[_store__WEBPACK_IMPORTED_MODULE_0__.default.settings.language].text
        }];
      }
    }
...
// Module
var code = "<div class=\"modal\">\n    <div class=\"modal__inner\">\n        <a href=\"/\" data-navigo class=\"modal__close\">\n            <span class=\"sr-only\"><hro-localize>Home</hro-localize></span>\n            <svg xmlns=\"http://www.w3.org/2000/svg\" width=\"24\" height=\"24\" viewBox=\"0 0 24 24\"><path d=\"M23.954 21.03l-9.184-9.095 9.092-9.174-2.832-2.807-9.09 9.179-9.176-9.088-2.81 2.81 9.186 9.105-9.095 9.184 2.81 2.81 9.112-9.192 9.18 9.1z\"/></svg>\n        </a>\n\n\n        <h1 class=\"label\">Mark 1:14-15 (RSVCE)</h1>\n\n        <p>Now after John was arrested, Jesus came into Galilee,\n        preaching the gospel of God, and saying, &ldquo;The time is\n        fulfilled, and the kingdom of God is at hand; repent, and believe in the\n        gospel.&rdquo;</p>\n\n        <div class=\"citation\">\n            <hr>\n\n            <p><em>The Revised Standard Version of the Bible: Catholic Edition</em>.\n            The Division of Christian Education of the\n            National Council of the Churches of Christ in the United States of\n            America, 1965, 1966.\n            <a href=\"https://www.biblegateway.com/\">www.biblegateway.com</a></p>\n        </div>\n    </div>\n</div>";
// Exports
module.exports = code;
...
// Module
var code = "<div class=\"modal\">\n    <div class=\"modal__inner\">\n        <a href=\"/\" data-navigo class=\"modal__close\">\n            <span class=\"sr-only\"><hro-localize>Home</hro-localize></span>\n            <svg xmlns=\"http://www.w3.org/2000/svg\" width=\"24\" height=\"24\" viewBox=\"0 0 24 24\"><path d=\"M23.954 21.03l-9.184-9.095 9.092-9.174-2.832-2.807-9.09 9.179-9.176-9.088-2.81 2.81 9.186 9.105-9.095 9.184 2.81 2.81 9.112-9.192 9.18 9.1z\"/></svg>\n        </a>\n\n\n        <h1 class=\"label\">Matthew 17:1-2 (RSVCE)</h1>\n\n        <p>And after six days Jesus took with him Peter and James and\n        John his brother, and led them up a high mountain apart. And\n        he was transfigured before them, and his face shone like the sun, and\n        his garments became white as light.</p>\n\n        <div class=\"citation\">\n            <hr>\n\n            <p><em>The Revised Standard Version of the Bible: Catholic Edition</em>.\n            The Division of Christian Education of the\n            National Council of the Churches of Christ in the United States of\n            America, 1965, 1966.\n            <a href=\"https://www.biblegateway.com/\">www.biblegateway.com</a></p>\n        </div>\n    </div>\n</div>";
// Exports
module.exports = code;
...
// Module
var code = "<div class=\"modal\">\n    <div class=\"modal__inner\">\n        <a href=\"/\" data-navigo class=\"modal__close\">\n            <span class=\"sr-only\"><hro-localize>Home</hro-localize></span>\n            <svg xmlns=\"http://www.w3.org/2000/svg\" width=\"24\" height=\"24\" viewBox=\"0 0 24 24\"><path d=\"M23.954 21.03l-9.184-9.095 9.092-9.174-2.832-2.807-9.09 9.179-9.176-9.088-2.81 2.81 9.186 9.105-9.095 9.184 2.81 2.81 9.112-9.192 9.18 9.1z\"/></svg>\n        </a>\n\n\n        <h1 class=\"label\">Matthew 26:26-28 (RSVCE)</h1>\n\n        <p>Now as they were eating, Jesus took bread, and blessed, and\n        broke it, and gave it to the disciples and said, &ldquo;Take, eat; this\n        is my body.&rdquo; And he took a cup, and when he had given\n        thanks he gave it to them, saying, &ldquo;Drink of it, all of you;\n        for this is my blood of the covenant, which is poured out\n        for many for the forgiveness of sins.</p>\n\n        <div class=\"citation\">\n            <hr>\n\n            <p><em>The Revised Standard Version of the Bible: Catholic Edition</em>.\n            The Division of Christian Education of the\n            National Council of the Churches of Christ in the United States of\n            America, 1965, 1966.\n            <a href=\"https://www.biblegateway.com/\">www.biblegateway.com</a></p>\n        </div>\n    </div>\n</div>";
// Exports
module.exports = code;
...
// Module
var code = "<div class=\"modal\">\n    <div class=\"modal__inner\">\n        <a href=\"/\" data-navigo class=\"modal__close\">\n            <span class=\"sr-only\"><hro-localize>Home</hro-localize></span>\n            <svg xmlns=\"http://www.w3.org/2000/svg\" width=\"24\" height=\"24\" viewBox=\"0 0 24 24\"><path d=\"M23.954 21.03l-9.184-9.095 9.092-9.174-2.832-2.807-9.09 9.179-9.176-9.088-2.81 2.81 9.186 9.105-9.095 9.184 2.81 2.81 9.112-9.192 9.18 9.1z\"/></svg>\n        </a>\n\n\n        <h1 class=\"label\">Matthew 26:36-39 (RSVCE)</h1>\n\n        <p>Then Jesus went with them to a place called\n        Gethsem&prime;ane, and he said to his disciples, &ldquo;Sit here, while\n        I go yonder and pray.&rdquo; And taking with him Peter and\n        the two sons of Zeb&prime;edee, he began to be sorrowful and troubled.\n        Then he said to them, &ldquo;My soul is very sorrowful,\n        even to death; remain here, and watch with me.&rdquo; And\n        going a little farther he fell on his face and prayed, &ldquo;My Father,\n        if it be possible, let this cup pass from me; nevertheless, not as I\n        will, but as thou wilt.&rdquo;</p>\n\n        <div class=\"citation\">\n            <hr>\n\n            <p><em>The Revised Standard Version of the Bible: Catholic Edition</em>.\n            The Division of Christian Education of the\n            National Council of the Churches of Christ in the United States of\n            America, 1965, 1966.\n            <a href=\"https://www.biblegateway.com/\">www.biblegateway.com</a></p>\n        </div>\n    </div>\n</div>\n\n\n\n\n";
// Exports
module.exports = code;
